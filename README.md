...
One 660 KB HTML file. No server. No database. No subscription. No account. No permission required.
...
- Recursive 65-slide self-teaching presentation (beginner → advanced in ~6 months)
...
| BiB v6.0 | **660 KB** | **Eternal. Zero recurring cost. Zero cloud dependency.** |

---

## The Pattern: Compressed Intelligence at Planetary Scale

Every vessel is a fractal seed. It contains the full system + the knowledge to use it + the mechanism to replicate itself.
...
This is independent, good-faith realware stewarded from POS, TT. MIT license — use, fork, modify, distribute freely. The gift-economy DNA means voluntary contributions (via the vessel itself) sustain continued evolution.
